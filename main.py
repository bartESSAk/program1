...
r1 = Radiobutton(okno, text="czajnik", variable=var, value=1)
r1.grid(row=4, column=2)
r1.select()

r2 = Radiobutton(okno, text="łyżka", variable=var, value=2)
r2.grid(row=5, column=2)

r3 = Radiobutton(okno, text="filiżanka", variable=var, value=3)
